...
import (
	monotonicclock "github.com/rajatjindal/wasip2-golang/wasi/clocks/monotonic-clock/v0.2.0-rc-2023-11-10"
...
//
//	get: func() -> option<result<option<own<trailers>>, error-code>>
//
//go:nosplit
